  ...
  return (
    <section className="relative z-10 flex flex-col items-center text-center mb-16 pt-12 md:pt-20">
      ...
      <FadeIn delay={0.2} className="flex flex-wrap items-center justify-center gap-3 mb-6">
        ...
        <span className="text-[10px] px-2.5 py-0.5 rounded-full bg-cyan-500/10 text-cyan-400 border border-cyan-500/20 font-semibold tracking-wider uppercase">
          Powered by Gemini Gem
        </span>
      </FadeIn>

      <FadeIn delay={0.3}>
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 dark:text-white mb-6 leading-[1.15] tracking-tight max-w-4xl mx-auto">
          {hero.title}
        </h1>
      </FadeIn>

      <FadeIn delay={0.4}>
        <p className="text-slate-600 dark:text-slate-300 text-base md:text-lg leading-loose mb-10 max-w-2xl mx-auto">
          {hero.description}
        </p>
      </FadeIn>
      ...
      >
        ...
        <Link
          ...
          className="w-full sm:w-auto px-8 py-4 rounded-xl text-base font-semibold text-slate-700 dark:text-slate-300 btn-glass inline-flex items-center justify-center"
        >
