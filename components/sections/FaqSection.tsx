        ...
        {faq.items.map((item, index) => (
          <FadeIn key={index} delay={0.1 * index}>
            <details className="group bg-white/[0.02] border border-white/5 rounded-2xl overflow-hidden [&_summary::-webkit-details-marker]:hidden">
              <summary className="flex justify-between items-center font-bold cursor-pointer list-none p-6 md:p-8 text-emerald-50 hover:text-emerald-400 transition-colors">
              ...
              <p className="text-slate-400 text-sm md:text-base mt-2 p-6 md:p-8 pt-0 leading-relaxed">
                {item.answer}
              </p>
            </details>
          </FadeIn>
