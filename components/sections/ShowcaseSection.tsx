      ...
      <FadeIn delay={0.2} className="w-full">
        <div className="relative w-full h-[500px] md:h-[700px] flex items-center justify-center perspective-[1000px] overflow-hidden">
          ...
          <div className="absolute top-1/2 -translate-y-1/2 w-full flex justify-between px-4 md:px-12 z-50 pointer-events-none">
            <button
              onClick={prevSlide}
              className="w-12 h-12 md:w-14 md:h-14 rounded-full bg-brand-card dark:bg-[#0B0F19]/80 backdrop-blur-md border border-[color:var(--border-color)] flex items-center justify-center text-slate-800 dark:text-white hover:bg-brand-card-hover hover:text-cyan-500 dark:hover:text-cyan-400 transition-all pointer-events-auto shadow-lg"
            >
