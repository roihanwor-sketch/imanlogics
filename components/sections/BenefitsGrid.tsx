    ...
    <section className="relative z-10 border-t border-white/5 pt-20 mt-12 mb-20">
      <FadeIn>
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold text-slate-900 dark:text-white">{benefits.title}</h2>
        </div>
      </FadeIn>
      ...
      <div className="flex flex-wrap justify-center gap-6 lg:gap-8 mb-12">
        {benefits.items.map((item, i) => (
          <FadeIn
            key={item.id}
            delay={0.1 * (i + 1)}
            className="w-full sm:w-[calc(50%-12px)] lg:w-[calc(33.333%-21.33px)]"
          >
            <div className="p-8 rounded-3xl bg-brand-card-inner border border-[color:var(--border-color)] hover:border-emerald-500/40 hover:bg-brand-card-hover transition-all text-center h-full flex flex-col items-center">
        ...
        <FadeIn delay={0.5} className="w-full sm:w-[calc(50%-12px)] lg:w-[calc(33.333%-21.33px)]">
          <div className="p-8 rounded-3xl bg-brand-card-inner border border-[color:var(--border-color)] hover:border-emerald-500/40 hover:bg-brand-card-hover transition-all text-center h-full flex flex-col items-center">
            ...
            <h4 className="text-lg font-bold text-emerald-400 mb-3">
              {benefits.highlightedItem.title}
            </h4>
            <p className="text-sm md:text-base text-slate-600 dark:text-slate-400 leading-relaxed max-w-xl mx-auto">
