          ...
          <FadeIn>
            <div className="mb-12">
              <h2 className="text-4xl font-bold mb-4 text-slate-900 dark:text-white">
                Portofolio &amp; Eksperimen
              </h2>
              <p className="text-slate-600 dark:text-slate-400 text-lg">
                Proyek sistem, AI, dan platform yang sedang dan telah dibangun.
              </p>
            </div>
          </FadeIn>
          ...
          <div className="flex flex-wrap justify-center gap-6">
            {items.map((item, index) => (
              <FadeIn
                key={item.slug}
                delay={0.1 * index}
                className="w-full md:w-[calc(50%-12px)] lg:w-[calc(33.333%-16px)] flex flex-col"
              >
                <div className="glass-card p-6 rounded-2xl flex flex-col h-full group w-full">
                  ...
                  <div className="flex-grow">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-[9px] px-1.5 py-0.5 rounded bg-cyan-500/10 text-cyan-400 border border-cyan-500/20 font-semibold tracking-wide uppercase scale-90 origin-left">
                        Gemini Gem
                      </span>
                    </div>
                    <Link
                    ...
                    >
                      <h3 className="text-lg font-bold text-slate-900 dark:text-white hover:text-cyan-550 dark:hover:text-cyan-400 transition-colors mb-3">
                        {item.name}
                      </h3>
                    </Link>
                  ...
                  <Link
                    href={`/portfolio/${item.slug}`}
                    className="inline-flex items-center text-sm font-medium text-slate-700 dark:text-slate-300 group-hover:text-cyan-500 dark:group-hover:text-cyan-400 transition-colors mt-auto pt-4 border-t border-slate-200 dark:border-white/5"
                  >
                    Lihat Detail
                    <svg
