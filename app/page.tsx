...
export default function Home() {
  ...
  return (
    <>
      <div className="fixed w-[600px] h-[600px] bg-cyan-500/10 dark:bg-cyan-900/20 top-[-200px] left-[-200px] rounded-full blur-[100px] z-[-1] pointer-events-none"></div>
      <div className="fixed w-[500px] h-[500px] bg-violet-500/10 dark:bg-violet-900/20 top-[20%] right-[-100px] rounded-full blur-[100px] z-[-1] pointer-events-none"></div>
      ...
      <main className="flex-grow">
        ...
        <section
          id="beranda"
          className="relative pt-40 pb-20 lg:pt-52 lg:pb-32 px-6 overflow-hidden"
        >
          <div className="max-w-5xl mx-auto text-center relative z-10">
            <FadeIn>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4 mb-20">
                <Link
                  href="/portfolio"
                  className="w-full sm:w-auto px-8 py-3.5 rounded-lg text-sm font-semibold text-cyan-50 btn-primary flex items-center justify-center"
                >
                  {hero.btn_primary}
                  <svg
                ...
                <Link
                  href="/products"
                  className="w-full sm:w-auto px-8 py-3.5 rounded-lg text-sm font-semibold text-white btn-glass flex items-center justify-center"
                >
                  {hero.btn_secondary}
                </Link>
              </div>
            ...
            <FadeIn delay={0.2} className="relative max-w-4xl mx-auto">
              <div className="absolute inset-0 bg-gradient-to-t from-brand-bg via-transparent to-transparent z-10 pointer-events-none"></div>
              <div className="bg-[#0D121F] border border-slate-800 p-4 rounded-2xl shadow-2xl relative overflow-hidden text-slate-300">
                  ...
                  <div className="col-span-1 md:col-span-3 h-48 rounded-lg bg-[#0B0F19]/80 border border-white/5 p-4 font-mono text-left text-xs leading-relaxed overflow-hidden relative flex flex-col">
                    ...
                    <div className="flex-grow space-y-1 text-slate-400 text-[10px] md:text-xs">
                      <div className="flex items-center gap-2">
                        ...
                        <span>
                          Content-Security-Policy (CSP) & Subresource Integrity (SRI) active
                        </span>
                      </div>
                      <div className="flex items-center gap-2">
        ...
        {/* 2. Fokus Utama */}
        <section className="py-16 border-y border-slate-200 dark:border-white/5 bg-slate-500/[0.01] relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10">
            <FadeIn>
              <p className="text-xs font-bold text-cyan-400 uppercase tracking-widest text-center mb-10">
                {fokus.title}
              </p>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 md:gap-6">
                {fokus.items.map((item, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className="text-center p-6 rounded-2xl bg-brand-card border border-[color:var(--border-color)] hover:border-cyan-500/20 hover:bg-brand-card-hover hover:shadow-[0_0_30px_rgba(34,211,238,0.05)] hover:-translate-y-1 transition-all duration-300 group flex flex-col justify-between min-h-[140px]"
                    >
                      <div className="w-10 h-10 rounded-xl bg-slate-500/5 dark:bg-white/5 flex items-center justify-center mx-auto mb-4 text-slate-500 dark:text-slate-400 group-hover:text-cyan-400 group-hover:bg-cyan-500/10 transition-all duration-300">
                        <Icon className="w-5 h-5" />
                      </div>
                      <div className="text-slate-700 dark:text-slate-300 font-bold text-xs md:text-sm group-hover:text-slate-900 dark:group-hover:text-white transition-colors leading-snug mt-auto">
                        {item}
                      </div>
                    </div>
                  )
          ...
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
            <FadeIn direction="right">
              <h2 className="text-3xl md:text-4xl font-bold mb-8 text-slate-900 dark:text-white">
                {tentang.title} <br />
                <span className="text-gradient">{tentang.highlight}</span>
              </h2>
            ...
            <FadeIn direction="left" className="relative">
              ...
              <div className="glass-card rounded-2xl p-8 aspect-square flex flex-col justify-between border border-white/10 relative z-10">
                ...
                <div className="my-auto py-6 flex justify-center items-center opacity-90 hover:opacity-100 transition-opacity duration-300 pointer-events-none select-none">
                  <svg
                    className="w-full max-w-[520px] h-56"
                    viewBox="0 0 320 120"
                    fill="none"
                  ...
                  >
                    ...
                    <path
                      d="M34 90 H70 L95 70 H130"
                      stroke="url(#circuit-grad-violet)"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                    />
            ...
            <div className="grid md:grid-cols-3 gap-6 relative">
              ...
              {alur.items.map((item, index) => {
                const borderColors = [
                  ...
                  'border-violet-500/20 dark:border-violet-500/30',
                ]
                const textColors = [
                ...
                const bgColors = [
                  'bg-brand-card dark:bg-[#0B0F19]',
                  'bg-cyan-500/10 dark:bg-[#0B0F19]',
                  'bg-violet-500/10 dark:bg-[#0B0F19]',
                ]
                const shadows = [
                  'shadow-[0_0_15px_rgba(0,0,0,0.03)] dark:shadow-[0_0_15px_rgba(255,255,255,0.05)]',
                  'shadow-[0_0_15px_rgba(34,211,238,0.05)] dark:shadow-[0_0_15px_rgba(34,211,238,0.1)]',
                  'shadow-[0_0_15px_rgba(168,85,247,0.05)] dark:shadow-[0_0_15px_rgba(168,85,247,0.1)]',
                ]
                ...
                return (
                  ...
                  >
                    <div
                      className={`w-12 h-12 rounded-lg ${bgColors[index]} border ${borderColors[index]} flex items-center justify-center mb-6 ${textColors[index]} font-bold font-mono text-lg ${shadows[index]}`}
                    >
                      {item.step}
                    </div>
        ...
        <section
          id="roadmap"
          className="py-24 px-6 relative border-t border-white/5 bg-white/[0.01]"
        >
          <div className="max-w-7xl mx-auto">
            <FadeIn>
              <div className="text-center mb-16">
                <h2 className="text-3xl font-bold mb-4 text-slate-900 dark:text-white">
                  🗺️ Roadmap <span className="text-gradient">Pengembangan</span>
                </h2>
                <p className="text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
                  Rencana pengembangan proyek dan eksperimen sistem digital ke depan.
                </p>
              </div>
            </FadeIn>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 relative">
              ...
              {roadmapItems.map((item, index) => {
                const accentClasses: Record<string, string> = {
                  ...
                  concept:
                    'hover:border-zinc-500/50 hover:shadow-[0_0_20px_rgba(113,113,122,0.15)]',
                }
                const hoverAccent =
                  accentClasses[item.status.toLowerCase()] || accentClasses.concept

                return (
                  <FadeIn key={index} delay={0.1 * index} className="group relative z-10 h-full">
                    <div
                      className={`glass-card p-6 md:p-8 rounded-2xl border border-white/5 flex flex-col justify-between h-full transition-all duration-300 hover:-translate-y-2 ${hoverAccent}`}
                    >
                      ...
                      <div className="mb-6 relative">
                        <h3 className="text-lg font-bold text-slate-800 dark:text-slate-100 mb-3 group-hover:text-cyan-400 transition-colors duration-300 pr-4">
                          {item.title}
                        </h3>
        ...
        <section className="py-24 px-6 border-t border-white/5">
          <div className="max-w-4xl mx-auto">
            <FadeIn className="glass-card rounded-3xl p-10 md:p-16 text-center relative overflow-hidden border border-white/10">
              ...
              <p className="text-slate-600 dark:text-slate-400 mb-10 max-w-xl mx-auto relative z-10 text-lg">
                {cta.description}
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4 relative z-10">
                <Link
                  href="/portfolio"
                  className="w-full sm:w-auto px-8 py-3.5 rounded-lg text-sm font-semibold text-cyan-50 btn-primary"
                >
                  {cta.btn_primary}
                </Link>
                <Link
